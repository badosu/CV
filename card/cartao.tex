...
\begin{document}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[every node/.style={anchor=center,font=\huge},anchor=center] (name) {
        \node{Amadeus}; \\
        \node{Folego}; \\
        \node{\color{jobtitlecolour}\normalsize\textit{consultor de software}}; \\
      };
      % sep line 1
      ...
      \matrix [below=\seplinedistance of hl1,%
        ...
        \node{\faGlobe}; & \node{Belo Horizonte};\\
        \node{\faEnvelope}; &\node{\small amadeusfolego@gmail.com};\\
        \node{\faPhone}; &\node{+55 11 94807 0450}; \\
        \node{\faGithub}; &\node{badosu}; \\
      };
      % sep line 2
  ...
  \begin{tikzpicture}[remember picture,overlay,inner sep=0pt]
    ...
    \node at (helper logo) {\includegraphics[width=\logowidth]{figures/logo.png}};
    % qr code

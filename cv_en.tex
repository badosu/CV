...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
 Email: \email{amadeusfolego@gmail.com} & Phone: 55 11 9554-3190 \\
...
\section{Profile}
  ...
  Interested in Math, Computer Science and {\em Math} in general.
...
\section{Professional Experience}
  ...
  \begin{innerlist}{\labelwidth 18em \leftmargin 1.53in \itemsep -.025in }
    \item [\textbf{01/2012}]{\textbf{Boo-box}~~~\scriptsize \url{http://boo-box.com} \normalsize}\\
    ...
    \item [\textbf{11/2009 - 06/2010}]{\textbf{Lumina1}}\\
      Advertising Agency, where I started working with web.
  \end{innerlist}
...
\section{Interesting Projects}
  ...
  \begin{innerlist}{\labelwidth 1em \leftmargin 1.53in \itemsep -.025in }
    ...
    \item{\textbf{Liste$\chi$}~~~\scriptsize \url{http://listechi.com} \normalsize}\\
      Project focused at the academic public. {\em (on development)}
  \end{innerlist}
...
\section{Academic Qualifications}
  ...
  \begin{innerlist}{\labelwidth 18em \leftmargin 1.13in \itemsep -.025in }
    \item[\textbf{01/2010 - 12/2012}]
      {\bf B.Sc. Mathematics} Universidade Federal do ABC (expected)

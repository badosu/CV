...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
 Email: \email{amadeusfolego@gmail.com}   & Celular: 11 952371152 \\
...
\section{Perfil}
  ...
  Interessado em Matemática, Ciências da Computação, Engenharia e {\em Hacking} em geral.\\
...
\section{Experiência Profissional}
  ...
  \begin{innerlist}{\labelwidth 18em \leftmargin 1.53in \itemsep -.025in }
    \item [\textbf{05/2012-}]{\textbf{Codeminer42}~~~\scriptsize \url{http://codeminer42.com} \normalsize}\\
      Boutique de desenvolvimento de software
    \item [\textbf{01/2012-05/2012}]{\textbf{Boo-box}~~~\scriptsize \url{http://boo-box.com} \normalsize}\\
      Empresa de tecnologia e advertising online

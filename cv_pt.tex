...
\begin{center}
	...
	\hspace{-10em} {Natural de Mauá, SP, 23/12/1988 - 1 filho - Casado}\\
	\hspace{-10em} {Rua Aurora, 787, apto. 52, Centro. São Paulo - SP, 01209-001}\\
	\hspace{-10em} {\email{amadeusfolego@gmail.com}}
...
\textit{Celular:} 11 9554-3190  & \textit{WWW:} \href{http://badosu.com/}{badosu.com} \\
\textit{Telefone:} 11 3337-3372 & Github: \github{amadeusfolego}  \\                      
                                                       
\end{tabular}

\section{Perfil}

	Profissional versátil com experiência em desenvolvimento para a web, utilizando principalmente .Net e Ruby On Rails. 
	Interessando em Matemática, Ciências da Computação, Engenharia e {\em Hacking} em geral.\\
	Possui familiaridade e capacidade de aprendizado em conceitos e tecnologias relevantes para a web.

\section{Técnica}
	Proficiência em .Net e Ruby, tendo trabalhado em ocasiões em projetos em outras linguagens. Realizo {\em front-end}, tendo o JavaScript e CSS em boa forma.

	Tenho experiência com OS X, Ubuntu, Mandriva, FreeBSD e Windows. Também sou capaz de realizar tarefas administrativas e programar scripts shell e zsh.

  Já trabalhei com SourceSafe e TFS, mas hoje em dia frequentemente utilizo o Git como ferramenta de controle de versionamento de código.

  Em termos de produtividade, utilizo o Vim como editor de texto primariamente ou a IDE específica da tecnologia, caso seja necessário.

	Outras tecnologias com as quais tive contato: Node, Faye, Lucene e Lua.
	
	Outras ferramentas computacionais: \textsc{Matlab}, R, SciPy, Processing, \LaTeX.

\section{Experiência Profissional}
	\vspace{3em}
	\begin{innerlist}{\labelwidth 18em \leftmargin 1.53in \itemsep -.025in }
		\item [\textbf{11/2011}]{\textbf{Buzzero}~~~\scriptsize \url{http://buzzero.com} \normalsize}\\
		 	Site de EAD, onde trabalhei em dois projetos
		...
		\item [\textbf{11/2009 - 06/2010}]{\textbf{Lumina1}}\\
			Agência online onde trabalhei em diversos projetos e iniciei minha experiência com Web
		\item [\textbf{12/2006 - 06/2007}]{\textbf{VIXIA do Brasil}}\\
			Estagiei por 6 meses integrando sistemas de gerenciamento eletrônico de documentos na Marítima Seguros
	\end{innerlist}

\section{Qualificações Acadêmicas}
	\vspace{3em}
	\begin{innerlist}{\labelwidth 18em \leftmargin 1.13in \itemsep -.025in }
		\item[\textbf{01/2010 - 09/2012}] 
